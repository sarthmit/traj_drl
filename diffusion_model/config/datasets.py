...
def cifar10():
    ...
    myhost = os.uname()[1]
    data_dir = '../LaplaceNet/data-local/images/cifar/cifar10/by-image'
...
def cifar100():
    ...
    myhost = os.uname()[1]
    data_dir = '../LaplaceNet/data-local/images/cifar/cifar100/by-image'
...
def mini_imgnet():
    ...
    data_dir = '../LaplaceNet/data-local/images/miniimagenet'
